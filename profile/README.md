...
### 🧐리서치 및 시장조사
#### 서비스 차별성은 무엇일까
|   |❤️워너플라이|✅워드|✅구글 드라이브|✅노션|✅메모장|
|:---:|:----:|:----:|:----:|:----:|:----:|
|파일 저장위치|워너 플라이 웹사이트|PC, 아이패드, 태블릿 등 개인 기기|구글|노션|메모장|
|글자수 세기|하단에 답변 별 글자수 세기 |하단에 N개 단어 클릭|도구에 글자수 세기 가능|AI 기능 사용 시 확인 가능|없음|
|맞춤법 검사|맞춤법 검사 버튼 클릭 시 하단에 교정된 내용 제공|맞춤법이 틀렸을 경우 빨간 줄로 알림|맞춤법이 틀렸을 경우 빨간 줄로 알림|AI 기능 사용 시 확인 가능 빨간줄 표시|빨간줄로 표시|
|유형별 카테고리|카테고리 별 답변을 유형별로 모아볼 수 있음|없음|없음|없음|없음|
|키워드 검색|특정 키워드가 포함된 답변을 모아볼 수 있음|CTRL+F로 검색할 수 있으나, 일일이 파일을 열어 검색해야 함|CTRL+F로 검색할 수 있으나, 일일이 파일을 열어 검색해야 함|좌측 사이드바를 통해 검색이 가능|CTRL+F로 검색할 수 있으나, 일일이 파일을 열어 검색해야 함|
...
<br> -> 사용자가 등록한 지원서들 중 입력한 키워드가 포함된 답변들을 모두 볼 수 있어 새로운 지원서를 보다 쉽고 빠르게 작성할 수 있습니다.
...
**1. BASIC / PRO요금제를 통한 부분 유료화**
1. BASIC 요금제: 유형별 카테고리화, 키워드 검색 기능 제한 이외 모두 사용 가능
2. PRO 요금제: 모든 기능 자유롭게 사용 가능
월(30일)마다 자동 결제: 4900원 

**2. 커스터마이징 유료화 (추후 2차, 3차 서비스론칭 시 수익모델 추가 예정)**
1. 지원서 커스터마이징, 합격한 자소서를 볼 수 있도록 한다 -> 동아리들이 이용시 요금 부과 

<img width="3225" alt="KakaoTalk_20230526_033704235" src="https://github.com/kusitms-wannafly/.github/assets/115688330/9632570b-0bb3-464a-afb5-921e374975ab">
